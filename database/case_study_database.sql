...
-- Chèn dữ liệu vào bảng vi_tri
INSERT INTO vi_tri (ten_vi_tri) VALUES 
('Quản Lý'),
('Nhân Viên');

-- Chèn dữ liệu vào bảng trinh_do
...
-- Chèn dữ liệu vào bảng loai_khach
...
-- Chèn dữ liệu vào bảng loai_dich_vu
...
INSERT INTO nhan_vien (ho_ten, ngay_sinh, so_cmnd, so_dien_thoai, email, dia_chi, vi_tri_id, trinh_do_id, bo_phan_id) VALUES
...
-- Chèn dữ liệu vào bảng dich_vu_di_kem
...
-- Chèn dữ liệu vào bảng hop_dong
INSERT INTO hop_dong (ngay_bat_dau, ngay_ket_thuc, tien_dat_coc, tong_tien, nhan_vien_id, khach_hang_id, dich_vu_id) VALUES
...
-- Chèn dữ liệu vào bảng hop_dong_chi_tiet
...
-- câu 3
SELECT id, ho_ten, ngay_sinh, TIMESTAMPDIFF(YEAR, ngay_sinh, CURDATE()) AS tuoi, dia_chi
FROM khach_hang
